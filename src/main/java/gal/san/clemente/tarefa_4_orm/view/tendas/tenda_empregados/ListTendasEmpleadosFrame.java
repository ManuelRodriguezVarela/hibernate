package gal.san.clemente.tarefa_4_orm.view.tendas.tenda_empregados;
...
import gal.san.clemente.tarefa_4_orm.view.converter.EmpleadosComboModel;
import gal.san.clemente.tarefa_4_orm.view.converter.TendaEmpregadoTableModel;
...
public class ListTendasEmpleadosFrame extends javax.swing.JFrame {
    ...
    public ListTendasEmpleadosFrame(IDAOManagerDB manager, Tenda tenda) throws ModelException {
        initComponents();
    ...
    private void initComponents() {
        ...
        detalle = new gal.san.clemente.tarefa_4_orm.view.tendas.tenda_empregados.DetalleTendaEmpleadoPanel();
    ...
    private void botonEliminarEmpleadoTendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarEmpleadoTendaActionPerformed
        if(JOptionPane.showConfirmDialog(rootPane, "Seguro que queres borralo empregado da tenda?", 
            ...
            try {
                TendaEmpleado tendaEmpleado = getTendaEmpleadoSeleccionado();
                manager.getTendaEmpleadoDAO().eliminar(tendaEmpleado.getId());
                obtenerDatos();
                //actualiza la tabla
                model.fireTableDataChanged();
            } catch (ModelException ex) {
    ...
    private gal.san.clemente.tarefa_4_orm.view.tendas.tenda_empregados.DetalleTendaEmpleadoPanel detalle;
