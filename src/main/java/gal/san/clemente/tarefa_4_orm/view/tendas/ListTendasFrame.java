...
import gal.san.clemente.tarefa_4_orm.view.tendas.tenda_productos.ListTendasProductosFrame;
...
import gal.san.clemente.tarefa_4_orm.view.converter.ProvinciasComboModel;
import gal.san.clemente.tarefa_4_orm.view.converter.TendaTableModel;
import gal.san.clemente.tarefa_4_orm.view.tendas.tenda_empregados.ListTendasEmpleadosFrame;
...
public class ListTendasFrame extends javax.swing.JFrame {
    ...
    public ListTendasFrame(IDAOManagerDB manager) throws ModelException, SQLException {
        initComponents();
        ...
        IDAOManagerJSON manager2 = (IDAOManagerJSON) DAOManagerFactory.getDAOManager("json");
        this.detalle.setModel(new ProvinciasComboModel(manager2.getProvinciaDAO("./provincias.json")));
    ...
    private void initComponents() {
        ...
        detalle = new gal.san.clemente.tarefa_4_orm.view.tendas.DetalleTendaPanel();
    ...
    private void botonEliminarTendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarTendaActionPerformed
        if(JOptionPane.showConfirmDialog(rootPane, "Seguro que queres borralo tenda?", 
            ...
            try {
                Tenda tenda = getTendaSeleccionado();
                manager.getTendaDAO().eliminar(tenda.getId());
                obtenerDatos();
                //actualiza la tabla
                model.fireTableDataChanged();
            } catch (ModelException ex) {
    ...
    private gal.san.clemente.tarefa_4_orm.view.tendas.DetalleTendaPanel detalle;
