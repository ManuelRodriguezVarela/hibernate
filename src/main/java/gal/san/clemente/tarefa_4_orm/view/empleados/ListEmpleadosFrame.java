package gal.san.clemente.tarefa_4_orm.view.empleados;

import gal.san.clemente.tarefa_4_orm.exception.ModelException;
import gal.san.clemente.tarefa_4_orm.model.Empleado;
import gal.san.clemente.tarefa_4_orm.view.converter.EmpleadoTableModel;
...
public class ListEmpleadosFrame extends javax.swing.JFrame {
    ...
    public ListEmpleadosFrame(IDAOManagerDB manager) throws ModelException {
        initComponents();
    ...
    private void initComponents() {
        ...
        detalle = new gal.san.clemente.tarefa_4_orm.view.empleados.DetalleEmpleadoPanel();
    ...
    private void botonEliminarEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarEmpleadoActionPerformed
        if(JOptionPane.showConfirmDialog(rootPane, "Seguro que queres borralo empleado?", 
            ...
            try {
                Empleado empleado = getEmpleadoSeleccionado();
                manager.getEmpleadoDAO().eliminar(empleado.getId());
                obtenerDatos();
                //actualiza la tabla
                model.fireTableDataChanged();
            } catch (ModelException ex) {
    ...
    private gal.san.clemente.tarefa_4_orm.view.empleados.DetalleEmpleadoPanel detalle;
