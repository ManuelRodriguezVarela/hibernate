package gal.san.clemente.tarefa_4_orm.view.productos;

import gal.san.clemente.tarefa_4_orm.exception.ModelException;
import gal.san.clemente.tarefa_4_orm.model.Producto;
import gal.san.clemente.tarefa_4_orm.view.converter.ProdutoTableModel;
...
public class ListProdutosFrame extends javax.swing.JFrame {
    ...
    public ListProdutosFrame(IDAOManagerDB manager) throws ModelException {
        initComponents();
    ...
    private void initComponents() {
        ...
        detalle = new gal.san.clemente.tarefa_4_orm.view.productos.DetalleProdutoPanel();
    ...
    private void botonEliminarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEliminarProdutoActionPerformed
        if(JOptionPane.showConfirmDialog(rootPane, "Seguro que queres borralo produto?", 
            ...
            try {
                ...
                manager.getProductoDAO().eliminar(producto.getId());
                obtenerDatos();
                //actualiza la tabla
                model.fireTableDataChanged();
            } catch (ModelException ex) {
    ...
    private gal.san.clemente.tarefa_4_orm.view.productos.DetalleProdutoPanel detalle;
