...
public class HibernateUtil {
    ...
    private static Object[] annotaticonClass = new Object[]{
        Tenda.class, Producto.class, Empleado.class, Cliente.class, TendaEmpleado.class,
        TendaProducto.class
    };
    ...
    private void setProperies() throws ModelException {
        ...
        String url = "jdbc:mysql://" + propertiesConf.getDbConnection().getAddress() 
                + ":" + propertiesConf.getDbConnection().getPort() 
